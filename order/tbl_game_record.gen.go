...
func newTblGameRecord(db *gorm.DB, opts ...gen.DOOption) tblGameRecord {
	...
	_tblGameRecord.CreatedTime = field.NewTime(tableName, "created_time")
	...
	_tblGameRecord.Sid = field.NewInt32(tableName, "sid")
	_tblGameRecord.Domain = field.NewString(tableName, "domain")
...
type tblGameRecord struct {
	...
	CreatedTime    field.Time    // 分区时间戳(等于bet_time)
...
func (t *tblGameRecord) updateTableName(table string) *tblGameRecord {
	...
	t.Sid = field.NewInt32(table, "sid")
