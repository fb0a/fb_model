...
const TableNameFbCmplPrivCopy = "fb_cmpl_priv_copy"
...
// TableName FbCmplPrivCopy's table name
func (*FbCmplPrivCopy) TableName() string {
	return TableNameFbCmplPrivCopy
}
