...
const TableNameFbBalanceTransaction2 = "fb_balance_transaction2"
...
// TableName FbBalanceTransaction2's table name
func (*FbBalanceTransaction2) TableName() string {
	return TableNameFbBalanceTransaction2
}
